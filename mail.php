...
$site_top = "https://creative-site.github.io/WED/index.html";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "nakonakota03@gmail.com";
...
$require = array('your-name','your-Email','your-message');
